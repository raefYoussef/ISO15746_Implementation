 ...
 * </p>
 * <ul>
 *   <li>{@link OPLmetamodel.impl.CollectionExpressionImpl#isIsUnique <em>Is Unique</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionExpressionImpl extends ExpressionImpl implements CollectionExpression {
	...
	protected EClass eStaticClass() {
		return OPLmetamodelPackage.Literals.COLLECTION_EXPRESSION;
	}
	...
	public void setIsUnique(boolean newIsUnique) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OPLmetamodelPackage.COLLECTION_EXPRESSION__IS_UNIQUE, oldIsUnique, isUnique));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OPLmetamodelPackage.COLLECTION_EXPRESSION__IS_UNIQUE:
				return isIsUnique();
		}
