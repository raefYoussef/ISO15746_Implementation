 ...
 * </p>
 * <ul>
 *   <li>{@link OPLmetamodel.impl.BooleanExpressionImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanExpressionImpl extends PrimitiveExpressionImpl implements BooleanExpression {
	...
	protected EClass eStaticClass() {
		return OPLmetamodelPackage.Literals.BOOLEAN_EXPRESSION;
	}
	...
	public void setBody(String newBody) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OPLmetamodelPackage.BOOLEAN_EXPRESSION__BODY, oldBody, body));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OPLmetamodelPackage.BOOLEAN_EXPRESSION__BODY:
				return getBody();
		}
