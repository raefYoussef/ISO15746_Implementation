 ...
 * </p>
 * <ul>
 *   <li>{@link OPLmetamodel.impl.FunctionRefImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionRefImpl extends MinimalEObjectImpl.Container implements FunctionRef {
	...
	protected EClass eStaticClass() {
		return OPLmetamodelPackage.Literals.FUNCTION_REF;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OPLmetamodelPackage.FUNCTION_REF__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OPLmetamodelPackage.FUNCTION_REF__NAME:
				return getName();
		}
