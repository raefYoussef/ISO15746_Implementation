...
/**
 * A sample validator interface for {@link OPLmetamodel.Objective}.
...
public interface ObjectiveValidator {
	...
	boolean validateAction(OptimizationMode value);
	boolean validateExpression(Expression value);
	boolean validateIsLinearRelaxation(boolean value);
}
